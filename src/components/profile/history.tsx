    ...
    return (
        <div className={style.history}>
            ...
            <div className={style.main}>
                <div className={style.history_items + style.date_1}>
                    <div className={style.title}>15 января,<br/> пятница</div>
                        ...
                        <div className={style.item}>
                            <div className={style.item_main}>
                                ...
                                <div className={style.item_desc}>
                                    <div className={style.item_title}>Вася добавил покупку<br/> на 4400 рублей</div>
                                </div>
                            </div>

                            <div className={style.item_time}>20:21</div>
                        </div>
                    </div>
                    ...
                    <div className={style.history_item}>
                        <div className={style.item}>
                            <div className={style.item_main}>
                                ...
                                <div className={style.item_desc}>
                                    <div className={style.item_title}>Саня заплатил за счет<br/> 5000 рублей</div>
                                </div>
                            </div>
                    ...
                    <div className={style.history_item}>
                        <div className={style.item}>
                            <div className={style.item_main}>
                                ...
                                <div className={style.item_desc}>
                                    <div className={style.item_title}>Гарик покинула группу<br/> “суета”</div>
                                </div>
                            </div>
                    ...
                    <div className={style.history_item}>
                        <div className={style.item}>
                            <div className={style.item_main}>
                                ...
                                <div className={style.item_desc}>
                                    <div className={style.item_title}>Апчихба был добавлен<br/> в группу “суета”</div>
                                </div>
                            </div>
