        ...
        <div className={style.admin_inside_group}>
            ...
            <div className={style.main}>
                ...
                <div className={style.items}>
                    ...
                    <div className={style.area}>
                        <input className={style.custom_checkbox} type="checkbox" id="color-4" name="color-4" value="indigo"></input>
                        <label for="color-4">
                    ...
                    <div className={style.input}>
                        <form action="">
                            <div className={style.input_number}>
                                <input type="number" placeholder="Введите сумму" id="count" name="count" required></input>
                            </div>
                        </form>
                    </div>
...
export default Admin_inside_group;